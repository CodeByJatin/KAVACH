def check_pqc(tls_version, cipher_suite, key_length, key_type="Unknown", signature_oid=None, pubkey_oid=None):
    """
    ...
    pqc_oids = [
        "1.3.6.1.4.1.2.267.8.3.3", # Kyber512
        "1.3.6.1.4.1.2.267.7.4.4", # Dilithium2
        "2.16.840.1.101.3.4.4.1", # ML-KEM-512
        "2.16.840.1.101.3.4.4.2", # ML-KEM-768
        "2.16.840.1.101.3.4.4.3", # ML-KEM-1024
        "2.16.840.1.101.3.4.3.1", # ML-DSA-44
        "2.16.840.1.101.3.4.3.2", # ML-DSA-65
        "2.16.840.1.101.3.4.3.3", # ML-DSA-87
    ]
    
    is_pqc_oid = (signature_oid in pqc_oids) or (pubkey_oid in pqc_oids)

    if is_pqc_oid or "ML-KEM" in cipher or "KYBER" in cipher:
        score_pqc = 250
