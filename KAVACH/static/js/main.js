...
function appendMessage(content, role, id = null) {
    ...
    msgDiv.innerHTML = `
        <div class="${innerClass} p-3 max-w-[85%] shadow-sm animate-fade-in break-words">
            <p class="text-xs leading-relaxed whitespace-pre-wrap break-all" ${id ? `id="${id}"` : ''}>${content}</p>
        </div>
    `;
